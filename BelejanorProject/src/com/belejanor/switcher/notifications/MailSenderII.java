...
public class MailSenderII {
     ...
     public MailSenderII(String domain, String host, String port, String username,
             String password) {
	     super();
	     this.domain = domain;
	     this.host = host;
	...
	public void sendEmail(ArrayList<String> to, String subject, String content, Ref<String> refError){
	        ...
	        MimeMessage message  = new MimeMessage(MemoryGlobal.sessionMail);
	        ...
	        try{
                ...
                MemoryGlobal.transportMail.sendMessage(message, message.getAllRecipients());
