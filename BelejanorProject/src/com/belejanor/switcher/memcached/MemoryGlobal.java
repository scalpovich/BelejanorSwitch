...
public final class MemoryGlobal{
	...
	private static void getErrorsFacilito(){
		...
		MapFacilito.put("91", "El autorizador de la transacción no tiene una conexión activa con el sistema".toUpperCase());
		MapFacilito.put("92", "Tiempo de espera agotado (Router)".toUpperCase());
		MapFacilito.put("93", "El modulo Web concluyó la transaccion por tiempo de espera excedido".toUpperCase());
		MapFacilito.put("94", "Un módulo Base del sistema no está disponible (Routers) ".toUpperCase());
		MapFacilito.put("95", "Existe un problema con la cola del sistema (No existe/No tiene permisos) ".toUpperCase());
		MapFacilito.put("96", "Surgió un problema al esperar por una respuesta a una transaccion por su identificador".toUpperCase());
		MapFacilito.put("97", "Los datos de autentificación no están correctos".toUpperCase());
		MapFacilito.put("98", "Los datos utilizados en el ruteo de la transacción no están correctos".toUpperCase());
		...
		MapFacilito.put("091", "El autorizador de la transacción no tiene una conexión activa con el sistema".toUpperCase());
		MapFacilito.put("092", "Tiempo de espera agotado (Router)".toUpperCase());
		MapFacilito.put("093", "El modulo Web concluyó la transaccion por tiempo de espera excedido".toUpperCase());
		MapFacilito.put("094", "Un módulo Base del sistema no está disponible (Routers) ".toUpperCase());
		MapFacilito.put("095", "Existe un problema con la cola del sistema (No existe/No tiene permisos) ".toUpperCase());
		MapFacilito.put("096", "Surgió un problema al esperar por una respuesta a una transaccion por su identificador".toUpperCase());
		MapFacilito.put("097", "Los datos de autentificación no están correctos".toUpperCase());
		MapFacilito.put("098", "Los datos utilizados en el ruteo de la transacción no están correctos".toUpperCase());
    ...
    private static void getTypeTrxCredencial(){
		...
		MapTypeTrxCredencial.put(1, "Autorización Compra".toUpperCase());
		MapTypeTrxCredencial.put(3, "Autorización Anulación".toUpperCase());
		MapTypeTrxCredencial.put(11, "Autorización Devolución".toUpperCase());
		MapTypeTrxCredencial.put(35, "Autorización Crédito/Carga Genérico".toUpperCase());
		MapTypeTrxCredencial.put(17, "Reversa autorización Compra".toUpperCase());
		MapTypeTrxCredencial.put(19, "Reversa autorización Anulación".toUpperCase());
		MapTypeTrxCredencial.put(27, "Reversa autorización Devolución".toUpperCase());
		MapTypeTrxCredencial.put(51, "Reverso de Autorización Crédito - Carga Genérico".toUpperCase());
		MapTypeTrxCredencial.put(49, "Reverso de Autorización Débito - Descarga Genérico".toUpperCase());
		MapTypeTrxCredencial.put(65, "Transferencias entre Cuentas (Débito)".toUpperCase());
		MapTypeTrxCredencial.put(81, "Reversa Transferencias entre Cuentas (Débito)".toUpperCase());
		MapTypeTrxCredencial.put(67, "Transferencias entre Cuentas (Crédito)".toUpperCase());
		MapTypeTrxCredencial.put(83, "Reversa Transferencias entre Cuentas (Crédito)".toUpperCase());
		MapTypeTrxCredencial.put(129, "Consulta Saldos - Disponibles y Movimientos por Tarjeta".toUpperCase());
		MapTypeTrxCredencial.put(513, "Asignación de PIN Inicial".toUpperCase());
		MapTypeTrxCredencial.put(257, "Cambio de PIN".toUpperCase());
		MapTypeTrxCredencial.put(529, "Rerversa Asignación PIN inicial".toUpperCase());
